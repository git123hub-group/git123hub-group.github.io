...
var cssP1 = document.createElement("link");
	...
	cssP1.href = "https://git123hub.github.io/static/retn/left.css";
	doc_head.appendChild(cssP1);

var cssP1b = document.createElement("div");
	cssP1b.className = "linkh"
	cssP1b.style.top = (+window._bd_share_config.slide.bdTop + 58 + (window._bd_share_config.slide.bdPos === "left") * 88) + "px";
